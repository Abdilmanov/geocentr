...
function ashe_custom_search_form( $html ) {
	...
	$html .= '<input type="search" name="s" id="s" placeholder="'. esc_attr__( 'Поиск...', 'ashe' ) .'" data-placeholder="'. esc_attr__( 'Введите, затем нажмите Enter...', 'ashe' ) .'" value="'. get_search_query() .'" />';
